...
import com.lljqiu.tools.threadPool.job.ThreadPoolStateJob;
import com.lljqiu.tools.threadPool.job.ThreadStackJob;
import com.lljqiu.tools.threadPool.job.ThreadStateJob;
import com.lljqiu.tools.threadPool.stack.ThreadPoolInfo;
import com.lljqiu.tools.threadPool.stack.ThreadPoolStatus;

/** 
 * ClassName: ThreadPoolImpl.java <br>
 * Description: 多线程池。<br>
 * Create by: name：liujie <br>email: liujie@lljqiu.com <br>
 * Create Time: 2017年7月31日<br>
 */
public class ThreadPoolImpl implements ThreadLiftCycle, ThreadPool {
